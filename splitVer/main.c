...
int main() 
{
    ...
    struct Producto* producto1 = crearProductoFalso("P001", "Producto1", "Descripción del Producto 1", "Categoría1", 1000, "Lab. de Chile", "Lote1", "01/01/2025", 50, 0);
    struct Producto* producto2 = crearProductoFalso("P002", "Producto2", "Descripción del Producto 2", "Categoría2", 2000, "Lab. de Chile", "Lote2", "01/01/2026", 30, 1);
    struct Producto* producto3 = crearProductoFalso("P003", "Producto3", "Descripción del Producto 3", "Categoría3", 1500, "Lab. Maver", "Lote3", "01/01/2027", 20, 0);
    struct Producto* producto4 = crearProductoFalso("P004", "Producto4", "Descripción del Producto 4", "Categoría4", 2500, "Lab. Maver", "Lote4", "01/01/2028", 10, 1);
